<template>
  ...
  <el-form-item>
    <el-input v-model="dto.nickname" maxlength="20" minlength="2">
      <template #prepend>
        {{ $t("registerView.dto.nickname") }}
      </template>
    </el-input>
  </el-form-item>
  <el-form-item>
...
import registerApi from "@/network/apis/account/Register"
import auth from "@/stores/auth"

const emits = defineEmits(["success"])

const dto = ref({ username: "", nickname: "", password: "" })
